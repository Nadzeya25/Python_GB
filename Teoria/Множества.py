*a #- раскрывание итерируемого объекта(распаковка)
...
m = set('moskva')   # создали из строки {'v', 's', 'k', 'a', 'o', 'm'}
m2 = set(['m','o','s','k','v','a'])  # создали из списка {'m', 'v', 's', 'k', 'a', 'o'}
m3 = set(range(5))   #создали из последовательности {0, 1, 2, 3, 4}

list_1 = [1,2,3,4,5,3,2,1]
m4 = set(list_1) #  {1, 2, 3, 4, 5}
# print(type(m4))  # создали сет множество из списка <class 'set'>
#- убирает дубли

m5 = {} #- не множество, а словарь
m6 = set() #- пустое множество
m7 = ()  #пустой кортеж

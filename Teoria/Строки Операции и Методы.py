...
.islower()
.isupper()
isinstance(obj, classinfo)#- возвращает либо True либо False, в зависимости от того,
#  является ли объект obj указанным классом classinfo
...
'='.join(a) #- элементы соединятся  знаком =
